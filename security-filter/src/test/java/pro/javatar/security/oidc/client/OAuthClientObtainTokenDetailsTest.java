...
public class OAuthClientObtainTokenDetailsTest {
    ...
    public void setUp() throws Exception {
        ...
        client.setPublicKeyCacheService(publicKeyCacheService);
    }
...
//        when(oidcConfiguration.getIdentityProviderHost()).thenReturn("identity-provider.host");
        ...
        when(EntityUtils.toString(httpEntity)).thenReturn(TestHelper.getStub("stub/identity-provider-response-stub.json"));
